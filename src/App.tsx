...
const ElectionPage: FC<PageProps> = ({ setActivePage }) => {
  ...
  const councilGeeversCharlesVideoId = "nZ1YuORz3Ug"; // <-- UPDATED
  const councilTomarWintersVideoId = "76l6GSE4lkU"; // Replace with actual ID when available
  ...
  // Helper to check if a question applies to a specific office type (Mayor or Council)
  ...
  // Function to handle topic toggle and scrolling
  const handleTopicToggle = (issueId: string, questionCount: number) => {
    ...
    // Scroll up if collapsing a long section
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-100 font-body text-slate-700 animate-fadeIn">
        <header className="relative bg-gradient-to-br from-slate-900 via-sky-800 to-indigo-900 text-white py-12 sm:py-16 px-4 rounded-b-2xl shadow-2xl overflow-hidden">
          <DotPattern dotColor="text-sky-700 opacity-10" rows={8} cols={10} />
          <div className="relative z-10 container mx-auto text-center">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
            ...
            <Card noHoverEffect className="p-0">
              <div className="p-6">
                ...
                <div className="text-center text-slate-500 text-sm mb-6 max-w-3xl mx-auto">
                  ...
                  {/* Optional: Add note about combined videos */}
                        ...
                        <div className="p-4 space-y-6">
                          {issue.questions.map((question) => {
                            ...
                            const renderResponseBlock = (
                              ...
                              // Determine next question's start time for video ending
                              ...
                              if (
                                ...
                                // Find the next question that applies to THIS slate
                                for (
                                  ...
                                  if (
                                    ...
                                    break; // Found the next relevant question
                                  }
                                }
                              }
                                    ...
                                    <>
                                      <div className="aspect-video bg-slate-200 rounded-lg mb-2 shadow-inner">
                                        {(() => {
                                          ...
                                          // Only add end parameter if next question exists and has a valid start time
                                          if (
                                            nextQuestionTimeSeconds >
                                            startSeconds
                                          ) {
                                            ...
                                            }`; // End 2 seconds after the start of the next question
                                          }
                  ...
                  <div className="p-6 bg-slate-50 rounded-xl border-2 border-slate-200 h-full flex flex-col">
                    ...
                    <div className="space-y-8 flex-grow flex flex-col">
                      ...
                      <div className="relative">
                        ...
                        {/* Box Content - UPDATED: border-2 border-slate-400 */}
