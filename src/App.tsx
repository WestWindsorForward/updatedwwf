...
// Footer Component and other data objects (forumData, projectsData) should go here.
// I am omitting them for brevity, but they should be in your final file.
// Make sure to include the full, correct projectsData object.

// ... [The rest of your page components and data objects go here] ...
// ... [HomePage, AboutPage, ProjectsPage, ProjectDetailPage, etc.] ...
