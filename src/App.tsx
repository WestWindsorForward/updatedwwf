        ...
        <Card className="bg-gradient-to-br from-slate-50 to-sky-50 p-0">
            <div className="p-4 sm:p-6 md:p-8">
                ...
                <div className="flex flex-col sm:flex-row mb-6 bg-white rounded-lg p-1">
                    <button onClick={() => setActiveTab("questions")} className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors flex items-center justify-center ${activeTab === "questions" ? "bg-sky-600 text-white" : "text-slate-600 hover:text-sky-600"}`}> <IconQuestionMark className="h-4 w-4 mr-2" /> Submit Questions </button>
                ...
                {activeTab === "questions" && (
                    <div>
                        <h3 className="text-lg font-semibold text-slate-800 mb-4 flex items-center"> <IconQuestionMark className="mr-2" /> Submit Your Question for the Town Hall </h3>
